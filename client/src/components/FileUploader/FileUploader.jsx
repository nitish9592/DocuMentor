...
import { fetchFiles, uploadFile, deleteFile, getDownloadLink, getPreviewLink } from "../../api/fileApi";
            ...
            .map((file, index) => (
              ...
              >
                <div className="flex gap-4 mt-1">
                  ...
                  <a
                    href={getDownloadLink(file.serverName)}
      ...
      {previewFile && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-4 rounded-lg shadow-lg max-w-3xl w-full relative">
            ...
            <iframe
              src={getPreviewLink(previewFile)}
              title="PDF Preview"
